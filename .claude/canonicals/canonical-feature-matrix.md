...
| Tool Usage History | GET /v1/usage/by-account/{id} | usage/{account_id}/{tool}/{timestamp}.json | usage_log | /dashboard/usage | partial — route exists, UI incomplete on most platforms |
