        ...
        {step === 4 && (
          <div className={styles.stepCard}>
            ...
            <div className={styles.stepBody}>
              ...
              {/* Pre-mail filing checklist (NTA Part III guidance) */}
              <div
                style={{
                  marginTop: '1.5rem',
              ...
              >
                ...
                >
                  Before You Mail — Filing Checklist
                </div>
                <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'grid', gap: '0.625rem' }}>
                  {[
                    ...
                    },
                    {
                      ...
                      body: (
                        <>
                          Mail to the IRS service center where you would file a current-year Form 1040. Check{' '}
                          <a
                          ...
                          >
                            irs.gov/filing/where-to-file-paper-tax-returns
                          </a>{' '}
                          for your state&apos;s address.
                        </>
                      ),
                    },
                    {
                    ...
                    >
                      ...
                      <span style={{ fontSize: '0.875rem', color: '#e4e4e7', lineHeight: 1.5 }}>
                        <strong style={{ color: '#fafafa' }}>{item.title}</strong> {item.body}
                      </span>
                    </li>
                  ))}
                </ul>
