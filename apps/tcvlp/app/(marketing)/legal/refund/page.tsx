...
export const metadata: Metadata = {
  ...
  description: 'Refund Policy for TaxClaim Pro subscriptions, tokens, and related digital purchases.',
}
...
export default function RefundPage() {
  return (
    ...
    >
      <LegalSection>
        <p>
          TaxClaim Pro provides a digital service offering subscriptions, tokens, and related digital deliverables (the &ldquo;Service&rdquo;). This Refund Policy applies to all purchases of the Service made through TaxClaim Pro. For help with an order, use the{' '}
      ...
      <LegalSection title="B. General Rule">
        <p>Because TaxClaim Pro offers digital products and services that can be activated or started quickly, purchases are generally <strong className="text-text-primary">non-refundable once delivery has started, access has been granted, files have been sent, or the Service has begun</strong>.</p>
      </LegalSection>
      ...
      <LegalSection title="E. How to Request a Refund Review">
        <ol className="space-y-2">
          {[
            'Submit your request through your official TaxClaim Pro support channel.',
      ...
      <LegalSection title="H. Form 843 — IRS Processing Disclaimer">
        <p>Refunds are not provided for IRS rejection, non-acceptance, or delay in processing any Form 843 submission Client prepared using TaxClaim Pro.</p>
      </LegalSection>

      <LegalSection title="I. Form 843 — Kwong Eligibility Determination">
        <p>Refunds are not provided for Kwong eligibility determinations made by the platform that Client or end-taxpayer disagree with.</p>
      </LegalSection>
    </LegalPageLayout>
  )
}
