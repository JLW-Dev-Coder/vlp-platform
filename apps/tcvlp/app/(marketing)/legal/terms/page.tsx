...
export const metadata: Metadata = {
  ...
  description: 'Terms for TaxClaim Pro digital products, installs, templates, implementation services, and platform use.',
}
  ...
  return (
    ...
    >
      ...
      <LegalSection title="Section 4. Account Access & Credentials">
        <p className="mb-3">Client is responsible for maintaining secure control of the accounts, workspaces, tools, and credentials used in connection with TaxClaim Pro services.</p>
      ...
      <LegalSection title="Section 5. Third-Party Platforms, Tools, and Dependencies">
        <p className="mb-3">TaxClaim Pro services may depend on third-party platforms, hosting providers, payment processors, communication tools, productivity systems, automation platforms, or related software selected by Client or Provider.</p>
      ...
      <LegalSection title="Section 7. Fees and Payment">
        <p className="mb-3">Client agrees to pay the fees presented at checkout, invoice, proposal, or service order for the purchased TaxClaim Pro product or service.</p>
      ...
      <LegalSection title="Section 17. Form 843 — Preparation Guide Status">
        <p>TaxClaim Pro generates PREPARATION GUIDES for IRS Form 843. The generated document is NOT an official IRS form and cannot be filed with the IRS as-is. Client must transfer the prepared information to the official IRS Form 843 (available at irs.gov/pub/irs-pdf/f843.pdf) before mailing to the IRS.</p>
      </LegalSection>

      <LegalSection title="Section 18. Form 843 — Power of Attorney Requirement">
        <p>Client must not submit end-taxpayer data to the platform without appropriate authorization or signed Form 2848 (Power of Attorney) where required.</p>
      </LegalSection>

      <LegalSection title="Section 19. Form 843 — IRS Acceptance Non-Guarantee + Kwong Window">
      ...
      <LegalSection title="Section 20. Form 843 — IRS Regulations Indemnity">
        <p>Client agrees to indemnify and hold Provider harmless from any claim, loss, or expense arising from Client&apos;s violation of professional ethics rules or IRS regulations, or from Client&apos;s violation of end-taxpayer rights, including unauthorized submission of third-party data.</p>
      </LegalSection>
      ...
      <div className="rounded-2xl border border-brand-primary/20 bg-brand-primary/5 p-8">
        ...
        <p className="text-sm leading-relaxed text-text-muted">By purchasing, scheduling, accessing, downloading, or using a TaxClaim Pro product or service, Client acknowledges that they have read, understood, and agreed to be bound by these terms.</p>
      </div>
    </LegalPageLayout>
  )
}
