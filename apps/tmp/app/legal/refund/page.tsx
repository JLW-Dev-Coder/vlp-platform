...
export const metadata: Metadata = {
  ...
  description: 'Refund Policy for Tax Monitor Pro installs, templates, setup services, and related digital purchases.',
}
...
export default function RefundPage() {
  return (
    ...
    >
      <LegalSection>
        <p>
          This Refund Policy applies to purchases made through Tax Monitor Pro, including setup packages, digital templates, implementation services, onboarding systems, automation builds, and related digital deliverables. For help with an order, use the{' '}
