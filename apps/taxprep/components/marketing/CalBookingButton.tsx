...
export interface CalBookingButtonProps {
  /** Cal.com slug, e.g. "tax-monitor-pro/tpvlp-intro". Defaults to `tppConfig.calIntroSlug`. */
  calLink?: string;
  /** Cal namespace, e.g. "tpvlp-intro". Defaults to `tppConfig.calIntroNamespace`. */
  namespace?: string;
  /** Dark-mode `cal-brand` override. Defaults to `tppConfig.brandColor`. */
  brandColor?: string;
  className?: string;
  children: ReactNode;
}
