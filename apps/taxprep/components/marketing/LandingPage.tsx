...
.tpp-lp .tpp-form-sd { position: relative; z-index: 1; }
.tpp-lp .tpp-form-sd label, .tpp-lp .tpp-form-sd .control-label, .tpp-lp .tpp-form-sd legend { font-family: var(--tpp-font-body) !important; font-size: 11px !important; font-weight: 700 !important; letter-spacing: 1.6px !important; text-transform: uppercase !important; color: var(--tpp-rose) !important; margin-bottom: 8px !important; display: block !important; }
.tpp-lp .tpp-form-sd input[type="text"], .tpp-lp .tpp-form-sd input[type="email"], .tpp-lp .tpp-form-sd input[type="tel"], .tpp-lp .tpp-form-sd input[type="url"], .tpp-lp .tpp-form-sd input[type="number"], .tpp-lp .tpp-form-sd input[type="password"], .tpp-lp .tpp-form-sd input[type="date"], .tpp-lp .tpp-form-sd input[type="time"], .tpp-lp .tpp-form-sd input[type="search"], .tpp-lp .tpp-form-sd select, .tpp-lp .tpp-form-sd textarea, .tpp-lp .tpp-form-sd .form-control { font-family: var(--tpp-font-body) !important; font-size: 16px !important; color: var(--tpp-text) !important; background: var(--tpp-champagne) !important; border: 1px solid var(--tpp-border) !important; border-radius: var(--tpp-radius-md) !important; padding: 14px 18px !important; width: 100% !important; height: auto !important; transition: border-color var(--tpp-dur-base) ease, box-shadow var(--tpp-dur-base) ease, background var(--tpp-dur-base) ease !important; box-shadow: none !important; }
...
.tpp-lp .tpp-form-sd .help-block, .tpp-lp .tpp-form-sd .form-text, .tpp-lp .tpp-form-sd small { font-size: 12px !important; color: var(--tpp-text-muted) !important; margin-top: 6px !important; letter-spacing: 0 !important; text-transform: none !important; font-weight: 400 !important; }
.tpp-lp .tpp-form-sd .has-error input, .tpp-lp .tpp-form-sd .has-error select, .tpp-lp .tpp-form-sd .has-error textarea, .tpp-lp .tpp-form-sd .is-invalid { border-color: var(--tpp-crimson) !important; }
.tpp-lp .tpp-form-sd .help-block.error, .tpp-lp .tpp-form-sd .invalid-feedback { color: var(--tpp-crimson) !important; }

.tpp-lp .sd-switchery-wrapper, .tpp-lp .tpp-form-sd .sd-switchery-wrapper { display: flex !important; align-items: center !important; gap: 14px !important; margin: 8px 0 !important; line-height: 1 !important; }
.tpp-lp .sd-switchery-wrapper label, .tpp-lp .tpp-form-sd .sd-switchery-wrapper label { margin: 0 !important; cursor: pointer !important; flex: 1 !important; line-height: 1.2 !important; display: flex !important; align-items: center !important; }
.tpp-lp .switchery, .tpp-lp .tpp-form-sd .switchery { flex: 0 0 auto !important; width: 44px !important; height: 24px !important; min-height: 24px !important; max-height: 24px !important; box-sizing: border-box !important; border-radius: 999px !important; border: 1px solid transparent !important; transition: background-color 300ms var(--tpp-ease-out), border-color 300ms ease, box-shadow 300ms ease !important; position: relative !important; cursor: pointer !important; vertical-align: middle !important; display: inline-block !important; align-self: center !important; padding: 0 !important; }
.tpp-lp .switchery > small, .tpp-lp .tpp-form-sd .switchery > small { width: 20px !important; height: 20px !important; min-height: 20px !important; max-height: 20px !important; top: 1px !important; bottom: auto !important; background: #FFFFFF !important; background-color: #FFFFFF !important; border-radius: 50% !important; box-shadow: 0 2px 6px rgba(0, 0, 0, 0.25) !important; position: absolute !important; box-sizing: border-box !important; margin: 0 !important; transform: none !important; transition: left 220ms var(--tpp-ease-out) !important; }
.tpp-lp .switchery, .tpp-lp .tpp-form-sd .switchery { background: var(--tpp-champagne-deep) !important; background-color: var(--tpp-champagne-deep) !important; border-color: var(--tpp-border) !important; box-shadow: inset 0 1px 3px rgba(139, 21, 56, 0.10) !important; }
.tpp-lp input[type="checkbox"]:checked + .switchery, .tpp-lp .tpp-form-sd input[type="checkbox"]:checked + .switchery { background: linear-gradient(135deg, var(--tpp-crimson) 0%, var(--tpp-crimson-deep) 100%) !important; background-color: var(--tpp-crimson-deep) !important; border-color: transparent !important; box-shadow: 0 2px 10px rgba(92, 13, 36, 0.35), inset 0 1px 2px rgba(0, 0, 0, 0.15) !important; }
