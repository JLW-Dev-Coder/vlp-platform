...
/* ====== SD form overrides — target SD's actual class structure ====== */

/* Outer scope — SD wraps everything in .app-form-embed */
.tpp-lp .tpp-form-sd .app-form-embed,
.tpp-lp .tpp-form-sd #forms-form-wrapper {
...
.tpp-lp .tpp-form-sd .card,
.tpp-lp .tpp-form-sd .card-block,
.tpp-lp .tpp-form-sd .forms-form-block {
  background: transparent !important;
  box-shadow: none !important;
  border: 0 !important;
  padding: 0 !important;
...
.tpp-lp .tpp-form-sd .card-header,
.tpp-lp .tpp-form-sd .forms-form-header {
  display: none !important;
}

/* Required-fields header */
.tpp-lp .tpp-form-sd #requiredMessage {
  display: none !important;
}

/* Field groups — SD uses .form-group with .embed-group / .animated-form-label modifiers */
.tpp-lp .tpp-form-sd .form-group,
.tpp-lp .tpp-form-sd .form-group.embed-group,
.tpp-lp .tpp-form-sd .form-group.animated-form-label {
  margin-bottom: 18px !important;
}

/* Labels — rose, uppercase, letter-spaced */
.tpp-lp .tpp-form-sd label,
.tpp-lp .tpp-form-sd .form-group label,
.tpp-lp .tpp-form-sd legend {
...
/* Required asterisk */
.tpp-lp .tpp-form-sd label .required {
  color: var(--tpp-crimson) !important;
  margin-left: 2px !important;
}

/* Helper text under labels */
.tpp-lp .tpp-form-sd .label-subtext,
.tpp-lp .tpp-form-sd .label-subtext * {
  font-family: var(--tpp-font-body) !important;
...
/* Inputs — champagne fill, rose focus */
.tpp-lp .tpp-form-sd input.form-control,
.tpp-lp .tpp-form-sd input[type="text"],
.tpp-lp .tpp-form-sd input[type="email"],
.tpp-lp .tpp-form-sd input[type="tel"],
.tpp-lp .tpp-form-sd input[type="url"],
.tpp-lp .tpp-form-sd input[type="number"],
.tpp-lp .tpp-form-sd input[type="password"],
.tpp-lp .tpp-form-sd input[type="date"],
.tpp-lp .tpp-form-sd input[type="time"],
.tpp-lp .tpp-form-sd input[type="search"],
.tpp-lp .tpp-form-sd select.form-control,
.tpp-lp .tpp-form-sd textarea.form-control {
  font-family: var(--tpp-font-body) !important;
  ...
  transition: border-color var(--tpp-dur-base) ease,
              box-shadow var(--tpp-dur-base) ease,
              background var(--tpp-dur-base) ease !important;
  box-shadow: none !important;
}

.tpp-lp .tpp-form-sd input::placeholder,
.tpp-lp .tpp-form-sd textarea::placeholder {
  color: var(--tpp-text-muted) !important;
  opacity: 0.7 !important;
}

.tpp-lp .tpp-form-sd input.form-control:focus,
.tpp-lp .tpp-form-sd select.form-control:focus,
.tpp-lp .tpp-form-sd textarea.form-control:focus,
.tpp-lp .tpp-form-sd .form-control:focus {
...
/* Switchery toggle — SD writes inline styles, must override with !important */
.tpp-lp .tpp-form-sd .sd-switchery-wrapper {
...
.tpp-lp .tpp-form-sd .sd-switchery-wrapper label {
  margin: 0 !important;
...
.tpp-lp .tpp-form-sd .switchery,
.tpp-lp .tpp-form-sd .switchery-small {
  ...
  padding: 0 !important;
  /* Override SD's inline style="background-color: rgb(255, 255, 255); ..." */
  ...
  transition: background-color 300ms var(--tpp-ease-out),
              border-color 300ms ease,
              box-shadow 300ms ease !important;
}

.tpp-lp .tpp-form-sd .switchery > small,
.tpp-lp .tpp-form-sd .switchery-small > small {
...
/* Switchery on-state — driven by checkbox sibling */
.tpp-lp .tpp-form-sd input[type="checkbox"]:checked + .switchery,
.tpp-lp .tpp-form-sd input[type="checkbox"]:checked + .switchery-small,
.tpp-lp .tpp-form-sd .sd-switchery-wrapper.active .switchery,
.tpp-lp .tpp-form-sd .sd-switchery-wrapper.active .switchery-small {
  ...
  box-shadow: 0 2px 10px rgba(92, 13, 36, 0.35),
              inset 0 1px 2px rgba(0, 0, 0, 0.15) !important;
}

/* Appointment scheduling card */
.tpp-lp .tpp-form-sd .appointment-intake-form-wrapper {
  margin: 18px 0 !important;
}

.tpp-lp .tpp-form-sd .appointment-intake-form-field-block {
  background: var(--tpp-champagne) !important;
  border: 1px dashed var(--tpp-border-strong) !important;
  border-radius: var(--tpp-radius-md) !important;
...
/* Appointment "Click to schedule" inner button — keep rose treatment */
.tpp-lp .tpp-form-sd .appointment-intake-form-field-block .btn.btn-primary {
  ...
  transition: transform var(--tpp-dur-base) var(--tpp-ease-out),
              box-shadow var(--tpp-dur-base) var(--tpp-ease-out) !important;
}

.tpp-lp .tpp-form-sd .appointment-intake-form-field-block .btn.btn-primary:hover {
  transform: translateY(-2px) !important;
  box-shadow: var(--tpp-shadow-rose) !important;
}

/* Submit button — primary CTA at bottom of form */
.tpp-lp .tpp-form-sd .form-actions,
.tpp-lp .tpp-form-sd .formActionsWithTooltip,
.tpp-lp .tpp-form-sd .btn-list {
  margin-top: 24px !important;
  display: flex !important;
  justify-content: center !important;
}

.tpp-lp .tpp-form-sd button.btn.btn-primary,
.tpp-lp .tpp-form-sd button.form-submit-button,
.tpp-lp .tpp-form-sd .btn.btn-primary.btn-sm {
  font-family: var(--tpp-font-body) !important;
...
.tpp-lp .tpp-form-sd button.btn.btn-primary:hover,
.tpp-lp .tpp-form-sd button.form-submit-button:hover,
.tpp-lp .tpp-form-sd .btn.btn-primary.btn-sm:hover {
  transform: translateY(-2px) !important;
  box-shadow: var(--tpp-shadow-rose) !important;
}

/* Validation states */
.tpp-lp .tpp-form-sd .has-error input,
.tpp-lp .tpp-form-sd .has-error select,
.tpp-lp .tpp-form-sd .has-error textarea,
.tpp-lp .tpp-form-sd .is-invalid,
.tpp-lp .tpp-form-sd .ng-invalid.ng-touched {
  border-color: var(--tpp-crimson) !important;
}

.tpp-lp .tpp-form-sd .help-block,
.tpp-lp .tpp-form-sd .form-text,
.tpp-lp .tpp-form-sd small.help-block {
  font-size: 12px !important;
  color: var(--tpp-text-muted) !important;
...
.tpp-lp .tpp-form-sd .help-block.error,
.tpp-lp .tpp-form-sd .invalid-feedback,
.tpp-lp .tpp-form-sd .sd-form-error-banner {
  color: var(--tpp-crimson) !important;
}

/* Form error banner — dismiss SD's default treatment */
.tpp-lp .tpp-form-sd .sd-form-error-banner {
  background: var(--tpp-blush-tint) !important;
  border-radius: var(--tpp-radius-sm) !important;
  padding: 10px 14px !important;
