...
export const tppConfig: PlatformConfig = {
  ...
  marketing: {
    ...
    megaMenu: {
      ...
      toolsExtras: [
        { label: 'Client Journey Blueprint', href: '/resources/8-phase-client-journey-blueprint.pdf' },
      ...
      ctaMagnetLabel: 'Free Client Journey Blueprint',
      ctaMagnetPath: '/resources/8-phase-client-journey-blueprint.pdf',
    },
