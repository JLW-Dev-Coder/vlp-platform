...
export const metadata: Metadata = {
  ...
  description: 'Refund Policy for Virtual Launch Pro subscriptions, tokens, and related digital purchases.',
}
...
export default function RefundPage() {
  return (
    ...
    >
      <LegalSection>
        <p>
          Virtual Launch Pro provides a digital service offering subscriptions, tokens, and related digital deliverables (the &ldquo;Service&rdquo;). This Refund Policy applies to all purchases of the Service made through Virtual Launch Pro. For help with an order, use the{' '}
      ...
      <LegalSection title="B. General Rule">
        <p>Because Virtual Launch Pro offers digital products and services that can be activated or started quickly, purchases are generally <strong className="text-text-primary">non-refundable once delivery has started, access has been granted, files have been sent, or the Service has begun</strong>.</p>
      </LegalSection>
