      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex min-w-0 items-center gap-6">
          <Link
            ...
            className="inline-flex shrink-0 items-center gap-1.5 text-sm text-brand-primary transition hover:text-brand-hover"
          >
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 border-l border-white/10 pl-4">
            ...
            <button
              ...
              onClick={onFinalize}
              disabled={finalized}
              className="rounded-md bg-gradient-to-r from-brand-primary to-brand-hover px-4 py-2 text-sm font-semibold text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
            >
