...
`/dashboard`, `/analytics`, `/calendar`, `/inquiries`, `/reports`, `/tokens`, `/affiliate`, `/payouts`, `/account`, `/account/payments`, `/profile`, `/profile/onboarding`, `/profile/preview`, `/support`, `/support/create`, `/usage`, `/notifications`, `/client-pool`, `/client-pool/[clientId]`, `/client-pool/[clientId]/compliance`, `/client-pool/[clientId]/report`
