            ...
            <div className="grid grid-cols-1 items-end gap-10 lg:grid-cols-[1.2fr_1fr]">
              <div>
                ...
                <h2 className="mt-3 font-sora text-[48px] font-bold leading-[1.02] tracking-tight md:text-[72px]">
                  Catch IRS issues
                  <br />
                  <span style={{ color: '#f97316' }}>before they cost you.</span>
                </h2>
                <p className="mt-5 max-w-[520px] text-[15px] leading-relaxed text-white/70">
                  A single TMP alert can catch a CP-2000 mismatch that would&apos;ve quietly cost a taxpayer five figures. You&apos;re
                  notified the day the transcript changes — so your CPA can close the issue in days, not months.
                </p>
              </div>
              <div>
