...
export const metadata: Metadata = {
  ...
  description: 'Refund Policy for Tax Tools Arcade subscriptions, tokens, and related digital purchases.',
}
...
export default function RefundPage() {
  return (
    ...
    >
      <LegalSection>
        <p>
          Tax Tools Arcade provides a digital service offering subscriptions, tokens, and related digital deliverables (the &ldquo;Service&rdquo;). This Refund Policy applies to all purchases of the Service made through Tax Tools Arcade. For help with an order, use the{' '}
      ...
      <LegalSection title="B. General Rule">
        <p>Because Tax Tools Arcade offers digital products and services that can be activated or started quickly, purchases are generally <strong className="text-text-primary">non-refundable once delivery has started, access has been granted, files have been sent, or the Service has begun</strong>.</p>
      </LegalSection>
