...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Tax Tools Arcade subscriptions, tokens, digital deliverables, and related services.',
}
...
export default function PrivacyPage() {
  return (
    ...
    >
      <LegalSection>
        <p>
          Tax Tools Arcade provides a digital service offering subscriptions, tokens, and related digital deliverables (the &ldquo;Service&rdquo;). This Privacy Policy explains how Tax Tools Arcade and its operator (&ldquo;Provider&rdquo;) may access, use, and handle Client information in connection with the Service and related support.
        </p>
      </LegalSection>
