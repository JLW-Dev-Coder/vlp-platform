...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Transcript Tax Monitor installs, templates, onboarding systems, and related digital services.',
}
...
export default function PrivacyPage() {
  return (
    ...
    >
      <LegalSection>
        <p>
          This Privacy Policy explains how Transcript Tax Monitor and its operator (&ldquo;Provider&rdquo;) may access, use, and handle Client information in connection with installs, setup work, templates, automation configuration, support, and related digital services.
        </p>
      </LegalSection>
