...
export const metadata: Metadata = {
  ...
  description: 'Terms for Transcript Tax Monitor subscriptions, tokens, digital deliverables, and platform use.',
}
...
export default function TermsPage() {
  return (
    ...
    >
      <LegalSection>
        <p>Transcript Tax Monitor provides a digital service offering subscriptions, tokens, and related digital deliverables (the &ldquo;Service&rdquo;). This Agreement is entered into by and between Transcript Tax Monitor&apos;s operating entity (&ldquo;Provider&rdquo;) and the individual or entity purchasing, accessing, or using the Service (&ldquo;Client&rdquo;).</p>
      </LegalSection>
