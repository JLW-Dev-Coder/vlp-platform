...
export const metadata: Metadata = {
  ...
  description: 'Terms for Games VLP subscriptions, tokens, digital deliverables, and platform use.',
}
...
export default function TermsPage() {
  return (
    ...
    >
      <LegalSection>
        <p>Games VLP provides a digital service offering subscriptions, tokens, and related digital deliverables (the &ldquo;Service&rdquo;). This Agreement is entered into by and between Games VLP&apos;s operating entity (&ldquo;Provider&rdquo;) and the individual or entity purchasing, accessing, or using the Service (&ldquo;Client&rdquo;).</p>
      </LegalSection>
