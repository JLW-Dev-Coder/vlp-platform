...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Games VLP installs, templates, onboarding systems, and related digital services.',
}
...
export default function PrivacyPage() {
  return (
    ...
    >
      <LegalSection>
        <p>
          This Privacy Policy explains how Games VLP and its operator (&ldquo;Provider&rdquo;) may access, use, and handle Client information in connection with installs, setup work, templates, automation configuration, support, and related digital services.
        </p>
      </LegalSection>
