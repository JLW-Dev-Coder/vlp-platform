...
export const metadata: Metadata = {
  title: 'Privacy Policy | Games VLP',
  description: 'Privacy Policy for Games VLP subscriptions, tokens, digital deliverables, and related services.',
}
...
export default function PrivacyPage() {
  return (
    ...
    >
      <LegalSection>
        <p>
          Games VLP provides a digital service offering subscriptions, tokens, and related digital deliverables (the &ldquo;Service&rdquo;). This Privacy Policy explains how Games VLP and its operator (&ldquo;Provider&rdquo;) may access, use, and handle Client information in connection with the Service and related support.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Contact">
        <p>
          For questions regarding this Privacy Policy, contact Games VLP through the{' '}
