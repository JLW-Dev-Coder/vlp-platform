...
export const metadata: Metadata = {
  ...
  description: 'Refund Policy for Website Lotto installs, templates, setup services, and related digital purchases.',
}
...
export default function RefundPage() {
  return (
    ...
    >
      <LegalSection>
        <p>
          This Refund Policy applies to purchases made through Website Lotto, including setup packages, digital templates, implementation services, onboarding systems, automation builds, and related digital deliverables. For help with an order, use the{' '}
