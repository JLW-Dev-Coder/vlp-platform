...
export const metadata: Metadata = {
  title: 'Terms of Service | Website Lotto',
  description: 'Terms for Website Lotto digital products, installs, templates, implementation services, and platform use.',
}
...
export default function TermsPage() {
  return (
    ...
    >
      <LegalSection>
        <p>This Agreement is entered into by and between Website Lotto&apos;s operating entity (&ldquo;Provider&rdquo;) and the individual or entity purchasing, accessing, or using Website Lotto products or services (&ldquo;Client&rdquo;).</p>
      </LegalSection>
      ...
      <LegalSection title="Section 4. Account Access & Credentials">
        <p className="mb-3">Client is responsible for maintaining secure control of the accounts, workspaces, tools, and credentials used in connection with Website Lotto services.</p>
      ...
      <LegalSection title="Section 5. Third-Party Platforms, Tools, and Dependencies">
        <p className="mb-3">Website Lotto services may depend on third-party platforms, hosting providers, payment processors, communication tools, productivity systems, automation platforms, or related software selected by Client or Provider.</p>
      ...
      <LegalSection title="Section 7. Fees and Payment">
        <p className="mb-3">Client agrees to pay the fees presented at checkout, invoice, proposal, or service order for the purchased Website Lotto product or service.</p>
      ...
      <div className="rounded-2xl border border-brand-primary/20 bg-brand-primary/5 p-8">
        ...
        <p className="text-sm leading-relaxed text-text-muted">By purchasing, scheduling, accessing, downloading, or using a Website Lotto product or service, Client acknowledges that they have read, understood, and agreed to be bound by these terms.</p>
      </div>
    </LegalPageLayout>
  )
}
