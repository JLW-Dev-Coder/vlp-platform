...
export const metadata: Metadata = {
  title: 'Privacy Policy | Website Lotto',
  description: 'Privacy Policy for Website Lotto installs, templates, onboarding systems, and related digital services.',
}
...
export default function PrivacyPage() {
  return (
    ...
    >
      <LegalSection>
        <p>
          This Privacy Policy explains how Website Lotto and its operator (&ldquo;Provider&rdquo;) may access, use, and handle Client information in connection with installs, setup work, templates, automation configuration, support, and related digital services.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Contact">
        <p>
          For questions regarding this Privacy Policy, contact Website Lotto through the{' '}
