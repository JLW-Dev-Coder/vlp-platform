...
export const metadata: Metadata = {
  title: 'Refund Policy | Website Lotto',
  description: 'Refund Policy for Website Lotto subscriptions, tokens, and related digital purchases.',
}
...
export default function RefundPage() {
  return (
    ...
    >
      <LegalSection>
        <p>
          Website Lotto provides a digital service offering subscriptions, tokens, and related digital deliverables (the &ldquo;Service&rdquo;). This Refund Policy applies to all purchases of the Service made through Website Lotto. For help with an order, use the{' '}
      ...
      <LegalSection title="B. General Rule">
        <p>Because Website Lotto offers digital products and services that can be activated or started quickly, purchases are generally <strong className="text-text-primary">non-refundable once delivery has started, access has been granted, files have been sent, or the Service has begun</strong>.</p>
      </LegalSection>
      ...
      <LegalSection title="E. How to Request a Refund Review">
        <ol className="space-y-2">
          {['Submit your request through your official Website Lotto support channel.','Include your name, purchase email, order date, and a clear description of the issue.','If available, include invoice, receipt, transaction ID, and any relevant project or workspace identifiers.'].map((item, i) => (
