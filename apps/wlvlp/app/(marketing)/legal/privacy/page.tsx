...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Website Lotto subscriptions, tokens, digital deliverables, and related services.',
}
...
export default function PrivacyPage() {
  return (
    ...
    >
      <LegalSection>
        <p>
          Website Lotto provides a digital service offering subscriptions, tokens, and related digital deliverables (the &ldquo;Service&rdquo;). This Privacy Policy explains how Website Lotto and its operator (&ldquo;Provider&rdquo;) may access, use, and handle Client information in connection with the Service and related support.
        </p>
      </LegalSection>
